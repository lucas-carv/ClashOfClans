...
namespace ClashOfClans.API.Migrations
{
    ...
    [Migration("20250919132256_atualizando_tabela")]
    partial class atualizando_tabela
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClashOfClans.API.Model.Guerras.Guerra", b =>
                {
                    b.HasOne("ClashOfClans.API.Model.Guerras.GuerraClan", "Clan")
                        .WithMany()
                        .HasForeignKey("ClanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guerra_guerra_clan_clan_id");
